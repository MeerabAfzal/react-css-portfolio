    ...
    >
      ...
      >
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          >
            I am a passionate game developer and programmer with experience in C++, Unity, and Web.I love building AI-driven 
            gameplay mechanics and optimizing game performance.
          </Typography>
          <Typography 
            variant={isMobile ? 'body1' : 'h6'} 
            sx={{
